...
using Ssit.CrossX.Games.Physics.Common.Decomposition;
using Ssit.CrossX.Games.Physics.Common.PolygonManipulation;
using Ssit.CrossX.Games.Physics.Dynamics;
using Ssit.CrossX.Games.Physics.Factories;

namespace Ssit.CrossX.Games.Physics.Common.TextureTools
{
    /// <summary>
