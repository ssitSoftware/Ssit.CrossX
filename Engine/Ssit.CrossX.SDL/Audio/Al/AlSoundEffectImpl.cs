...
internal class AlSoundEffectImpl: ISoundEffect, IInstanceCountingResource
{
    ...
    public AlSoundEffectImpl(IIoCContainer iocContainer, Stream stream)
    {
    ...
    public ISoundEffectInstance CreateInstance() => _iocContainer.IoCConstruct<AlSoundEffectInstanceImpl>(this);
