...
internal class AlSoundEffectInstanceImpl: ISoundEffectInstance
{
    public readonly Guid Guid = Guid.NewGuid();
    private readonly AlSoundEffectImpl _soundEffect;
    ...
    public AlSoundEffectInstanceImpl(AlSoundEffectImpl soundEffect, IEventSource eventSource, ISoundManager soundManager)
    {
