...
using RetroGunslinger.Core.Game.Objects;
using RetroGunslinger.Core.Game.Objects.Devices;
using RetroGunslinger.Core.Game.Objects.Pushables;
using Ssit.CrossX;
...
public class GameTemplate: IGameTemplate
{
    ...
    public IFilesProvider AssetsProvider { get; } = new AggregatedFilesProvider()
        .AddProvider("assets:",
            new EmbeddedFilesProvider(typeof(GameTemplate).Assembly, "RetroGunslinger.Core.Assets"))
    ...
    public RgbaColor EmptyColor => new(192, 128, 192);
