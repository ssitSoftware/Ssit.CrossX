...
public class Palette
{
    ...
    [
        ...
        new("Author's FAV 1", RgbaColor.Transparent, 0x101010, 0xfda880, 0x562820, 0xfe3a26),
        new("Author's FAV 2", RgbaColor.Transparent, 0x101010, 0xd6d66e, 0x5b442f, 0xee5436)
    ];
