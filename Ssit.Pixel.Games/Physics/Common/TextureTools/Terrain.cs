...
using Ssit.Pixel.Games.Physics.Common.Decomposition;
using Ssit.Pixel.Games.Physics.Common.PolygonManipulation;
using Ssit.Pixel.Games.Physics.Dynamics;
using Ssit.Pixel.Games.Physics.Factories;

namespace Ssit.Pixel.Games.Physics.Common.TextureTools
{
    /// <summary>
