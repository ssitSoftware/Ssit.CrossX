...
using Ssit.Pixel.Games.Physics.Factories;
...
namespace Ssit.Pixel.Games.Physics.Dynamics
{
    ...
    public class BreakableBody
    {
        ...
        public BreakableBody(World world, IEnumerable<Vertices> vertices, float density, Vector2 position = new(), float rotation = 0)
        {
            _world = world;
