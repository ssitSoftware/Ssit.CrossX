...
public interface IRenderer
{
    ...
    void DrawTexture(ITexture texture, Rectangle targetRectangle, Rectangle? sourceRectangle = null, IEffect effect = null);
    ...
    void DrawPrimitives(IVertexBuffer vertexBuffer, ITexture texture = null, 
